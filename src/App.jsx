...
function App() {
  ...
  const renderContent = () => {
    switch (currentPage) {
      case 'listing':
        return <ProductListing setPage={setCurrentPage} setProductId={setSelectedProductId} searchQuery={searchQuery} />;
      case 'details':
      ...
      case 'signup':
        return <Signup setPage={setCurrentPage} setUser={setUser} />;
      case 'addProduct':
        return <AddProduct setPage={setCurrentPage} />;
      default:
        return (
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header setPage={setCurrentPage} setSearchQuery={setSearchQuery} user={user} onLogout={handleLogout} />
